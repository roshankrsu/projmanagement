...
import { AvailabeTaskStatus, AvailabeUserRole, UserRolesEnum } from "../utils/constants.js";
...
const deleteMember = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, projectMember, "Project member role deleted successfully"))
